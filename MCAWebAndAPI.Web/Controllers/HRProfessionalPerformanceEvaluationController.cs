        ...
        public async Task<ActionResult> EditPerformanceEvaluation(FormCollection form, ProfessionalPerformanceEvaluationVM viewModel, string site)
        {
            ...
            try
            {
                ...
                if (viewModel.StatusForm == "Initiated" || viewModel.StatusForm == "Draft")
                    ...
                    string.Format(EmailResource.ProfessionalPerfromanceEvaluation, siteUrl, UrlResource.ProfessionalPerformancePlan, viewModel.ID), string.Format(""));
                ...
                if (viewModel.StatusForm == "Pending Approval 1 of 2")
                    ...
                    string.Format(EmailResource.ProfessionalPerfromanceEvaluation, siteUrl, UrlResource.ProfessionalPerformancePlan, viewModel.ID), string.Format("Approved By Level 1"));
