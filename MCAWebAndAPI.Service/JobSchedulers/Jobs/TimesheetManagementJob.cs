...
{
    public class TimesheetManagementJob : IJob
    {
        ...
        public void Execute(IJobExecutionContext context)
        {
            ...
            ITimesheetScheduleService _timesheetSchedule = new TimesheetScheduleService();
            _timesheetSchedule.SetSiteUrl(siteUrl);
            _timesheetSchedule.SendEmailEveryMonth();
